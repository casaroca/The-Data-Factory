...
mkdir -p /factory/workers/utilities/simple_extractor_v5

# Create the extractor
cat << 'EOF' > /factory/workers/utilities/simple_extractor_v5/extract_all.py
#!/usr/bin/env python3
import os
import subprocess
import shutil
...
chmod +x /factory/workers/utilities/simple_extractor_v5/extract_all.py

echo "--- Simple Bulk Extractor Ready v5 ---"
echo ""
echo "TO RUN:"
echo "cd /factory/workers/utilities/simple_extractor_v5"
