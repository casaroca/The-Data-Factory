...
cat << 'EOF' > $PROJECT_DIR/info_collector_v2.py
import os
import requests
import feedparser
import time
...
MAX_WORKERS = 40 # Increased for the large number of sources
...
SOURCES=[
    ...
    {'url': 'https://publicdomainreview.org/feed/', 'category': 'public_domain_history'},
]
