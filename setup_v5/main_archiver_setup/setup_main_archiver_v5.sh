...
# --- FIX: Set ownership immediately after creating directories (excluding dynamic data dirs) ---
sudo chown -R $USER:$USER $PROJECT_DIR $LOG_DIR $ARCHIVE_COPY_DIR

# --- 3. Application File (Assume already in place or handle separately) ---
echo "[+] main_archiver.py is assumed to be in place."
