...
echo "--- Setting up Stats Collector v2 v5 ---"
...
# --- 2. Define Paths ---
PROJECT_DIR="/factory/workers/collectors/stats_collector_v2_v5"
LOG_DIR="/factory/logs"
LOG_FILE="$LOG_DIR/stats_collector_v2.log"
...
cp /home/tdf/stats_collector_v2.py $PROJECT_DIR/stats_collector_v2.py
...
sudo bash -c "cat << EOF > /etc/systemd/system/stats_collector_v2_v5.service
[Unit]
Description=Stats Collector Service v2 v5
...
sudo systemctl daemon-reload
sudo systemctl start stats_collector_v2_v5
sudo systemctl enable stats_collector_v2_v5

echo "--- Stats Collector v2 Setup Complete v5 ---"
echo "To check the status, run: sudo systemctl status stats_collector_v2_v5"
