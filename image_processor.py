...
# --- Setup Logging ---
logging.basicConfig(filename=os.path.join(LOG_DIR, 'image_processor.log'), level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
def main():
    ...
    while True:
        ...
        logging.info("--- Image Processor cycle finished. Waiting 1 minute... ---")
        time.sleep(60)
