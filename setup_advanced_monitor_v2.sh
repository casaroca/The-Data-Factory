...
echo "--- Setting up Advanced Live-Log Monitor v2 ---"
...
# --- Configuration ---
# This is the complete list of all services planned for the data factory
SERVICES=(
    "librarian"
    "jr_librarian"
    "topic_puller"
...
while true; do
    ...
    # --- Header ---
    echo "========================================================================================================================"
    echo "                                    Next GenAi Data Factory - Live Operations Monitor v2"
    echo "========================================================================================================================"
    date
    echo ""
...
echo "--- Advanced Monitor v2 Setup Complete ---"
