...
echo "--- Setting up Advanced Monitor v8 ---"
...
# --- Configuration (Updated to reflect consolidated librarian) ---
SERVICES=(
...
while true; do
    ...
    # --- Header ---
    echo "========================================================================================================================"
    echo "                                    Next GenAi Data Factory - Live Operations Monitor v8"
    echo "========================================================================================================================"
    date
    echo ""
...
echo "--- Advanced Monitor v8 Setup Complete ---"
