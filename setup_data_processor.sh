...
# --- 1. Define Paths ---
PROJECT_DIR="/factory/workers/processors/data_processor"
LOG_DIR="/factory/logs"
INBOX_DIR="/factory/data/processed" # Inbox is the sorter's output
...
cat << 'EOF' > $PROJECT_DIR/data_processor.py
import os
import time
import logging
import re
...
# --- Configuration ---
LOG_DIR = "/factory/logs"
INBOX_DIR = "/factory/data/processed"
OUTPUT_PROMPTS_CSV_DIR = "/factory/data/final/prompts/csv"
OUTPUT_PROMPTS_JSONL_DIR = "/factory/data/final/prompts/jsonl"
OUTPUT_INSTRUCTIONS_CSV_DIR = "/factory/data/final/instructions/csv"
OUTPUT_INSTRUCTIONS_JSONL_DIR = "/factory/data/final/instructions/jsonl"
...
sudo bash -c "cat << EOF > /etc/systemd/system/data_processor.service
[Unit]
...
# --- 7. Start the Service ---
echo "[+] Setting permissions and starting Data Processor service..."
sudo chown -R $USER:$USER $PROJECT_DIR $OUTPUT_PROMPTS_CSV_DIR $OUTPUT_PROMPTS_JSONL_DIR $OUTPUT_INSTRUCTIONS_CSV_DIR $OUTPUT_INSTRUCTIONS_JSONL_DIR
sudo systemctl daemon-reload
sudo systemctl start data_processor
sudo systemctl enable data_processor

echo "--- Data Processor Setup Complete ---"
echo "To check the status, run: sudo systemctl status data_processor"
